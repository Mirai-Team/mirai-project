...
#include "MiraiProject/encryption/basic.hpp"
...
{
    for (unsigned int i = dataSize; i--; )
        static_cast<char*>(data)[i] = static_cast<char>(
            static_cast<char*>(data)[i] ^ static_cast<char*>(data2)[i%data2Size]);
}
